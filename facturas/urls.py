...
from .views import (
    ...
    ajaxloadunidad, ajaxsaverdetallefactura, detallefacturaproveedor_delete, actualizadormasivo
)
...
urlpatterns = [
    ...
    path('actualizadormasivo/', actualizadormasivo, name='actualizadormasivo')
]
